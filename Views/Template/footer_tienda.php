	<?php 
	 ...
	 ?>
	<!-- Footer -->
	<footer class="bg-second-color p-t-50">
		<div class="container bg-second-color">
			<div class="row">
				<div class="col-sm-6 col-lg-6 p-b-50 text-center">
					...
					<ul>
						...
						<li class="p-b-10">
							<a href="<?= base_url() ?>/tienda/categoria/<?= $cat['idcategoria'].'/'.$cat['ruta'] ?>" class="stext-107 cl7 hov-cl1 trans-04 text-white">
								<?= $cat['nombre'] ?>
							</a>
						</li>
						<?php } ?>
				...
				<div class="col-sm-6 col-lg-6 p-b-50 text-center d-flex flex-column justify-content-center">
					<h4 class="stext-301 cl0 p-b-30">
						Contacto
					</h4>

					<p class="stext-107 cl7 size-201 m-auto text-white">
						<?= DIRECCION ?> <br>
		...
		<div class="p-t-40 bg-first-color">
				<p class="stext-107 cl6 txt-center">
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
					<?= NOMBRE_EMPESA; ?> | <?= WEB_EMPRESA; ?> | Imperial-Cañete-Lima | <a href="https://colorlib.com" target="_blank">Colorlib</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				</p>
			</div>
	</footer>
